...
var rotues_data_1 = __importDefault(require("../../data/rotues.data"));
            ...
            switch (_c.label) {
                ...
                case 4:
                    ...
                    return [4 /*yield*/, stripe_1.stripe.checkout.sessions.create({
                            success_url: "".concat(process.env.NEXT_PUBLIC_SERVER_URL).concat(rotues_data_1.default.thankYou, "?orderId=").concat(order.id),
                            cancel_url: "".concat(process.env.NEXT_PUBLIC_SERVER_URL).concat(rotues_data_1.default.cart),
                ...
                case 6:
                    err_1 = _c.sent();
                    console.error("🚀 ~ .mutation ~ err", err_1);
